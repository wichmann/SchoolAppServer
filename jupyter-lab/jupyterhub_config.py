...
#  Choices: any of ['sha256', 'sha3_256', 'md5-sha1', 'blake2b', 'blake2s', 'md5', 'sha384', 'sha224', 'sha3_224', 'sha3_384', 'sha1', 'shake_256', 'sha512_224', 'sha512_256', 'ripemd160', 'sha3_512', 'sha512', 'sm3', 'shake_128']
#  Default: 'sha256'
...
#  Choices: any of ['sha256', 'sha3_256', 'sha3_384', 'blake2b', 'blake2s', 'md5', 'sha1', 'sha384', 'sha224', 'sha3_512', 'sha512', 'sha3_224']
#  Default: 'sha256'
...
##########
# TODO: Check how to update this to the new method with PasswordIdentityProvider.
import os
from jupyter_server.auth import passwd
hashed_password = passwd(os.environ['ADMIN_PASSWORD'])
