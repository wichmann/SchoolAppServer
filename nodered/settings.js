...
// get password from env variable, but remove first and last character, because JS adds extra quotation marks (sic!)
password_string = process.env.NODE_RED_ADMIN_PASSWORD.substring(1, process.env.NODE_RED_ADMIN_PASSWORD.length-1);
 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            // generate password hash with bcrypt from given password string
            password: require('bcrypt').hashSync(password_string, 8),
            permissions: "*"
        }]
    },
